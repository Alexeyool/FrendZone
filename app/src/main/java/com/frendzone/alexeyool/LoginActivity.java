...
public class LoginActivity extends AppCompatActivity {
    ...
    protected void onCreate(final Bundle savedInstanceState) {
        ...
        fbLoginButton = (LoginButton) findViewById(R.id.AL_button_facebook_login);
        userNameView = (TextView) findViewById(R.id.AL_textview_login);

        final Button deAuthButton = (Button) findViewById(R.id.AL_button_deauth);
                    ...
                    public void onCompleted(GraphResponse response) {
                        try {
                            if(response.getError() != null) {
                                Toast.makeText(LoginActivity.this, getResources().getString(R.string.failed) + response.toString(), Toast.LENGTH_LONG).show();
                            }
...
//        final Button permsButton = (Button) findViewById(R.id.AL_button_permissions);
//
